...
impl StateData {
    ...
    pub fn has_property_eq_kw(&self, prop_name: PropertyName, kw: KwValue) -> bool {
        match self.default_properties.get(&prop_name) {
    ...
    pub fn get_background_rule(&self) -> Option<TextureRule> {
        match self.default_properties.get(&PropertyName::BACKGROUND_IMAGE_RULE) {
    ...
    pub fn get_background_image(&self) -> Option<ImageData> {
        match self.default_properties.get(&PropertyName::BACKGROUND_IMAGE) {
